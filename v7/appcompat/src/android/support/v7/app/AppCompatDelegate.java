...
public abstract class AppCompatDelegate {
     ...
     */
    public static final int MODE_NIGHT_SAMHAIN = 3;
     ...
     * @see #setNightMode(int)
     */
    public static final int MODE_NIGHT_PIXEL = 4;
    ...
    /** @hide */
    @RestrictTo(GROUP_ID)
    @IntDef({MODE_NIGHT_NO, MODE_NIGHT_YES, MODE_NIGHT_PIXEL, MODE_NIGHT_SAMHAIN, MODE_NIGHT_AUTO,
            MODE_NIGHT_FOLLOW_SYSTEM, MODE_NIGHT_UNSPECIFIED})
    @Retention(RetentionPolicy.SOURCE)
    public @interface NightMode {}

    @IntDef({MODE_NIGHT_NO, MODE_NIGHT_YES, MODE_NIGHT_PIXEL, MODE_NIGHT_SAMHAIN, MODE_NIGHT_FOLLOW_SYSTEM})
    @Retention(RetentionPolicy.SOURCE)
